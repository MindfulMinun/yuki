...
export default class Yuki {
  ...
  tokenizeScript() {
    ...
    while (this.chunk = script.slice(i)) {
      ...
      const consumed = this._tokenIdentifier() || this._tokenComment() || this._tokenWhitespace() || // this._tokenLine()       ||
      this._tokenJump() || this._tokenString() || this._tokenNumber() || // this._tokenJsx()        ||
      // this._tokenRegex()      ||
      // this._tokenJs()         ||
      this._tokenLiteral();
